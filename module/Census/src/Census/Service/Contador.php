...
class Contador extends AbstractService
{
	public function total()
	{
    	...
    	$efetivo['TC'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='TC' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['Maj'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='Maj' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['Cap'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='Cap' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['1Ten'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='1º Ten' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['2Ten'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='2º Ten' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['ST'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='ST' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['1Sgt'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='1º Sgt' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['2Sgt'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='2º Sgt' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['3Sgt'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='3º Sgt' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['Cb'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='Cb' AND pol_SubUnidade<>'TRC'")->execute()->count();
    	$efetivo['Sd'] = $adapter->query("SELECT * FROM `policial` WHERE pol_PostoGraduacao='Sd' AND pol_SubUnidade<>'TRC'")->execute()->count();
